...
prompt = f'''Here are video chunks containing video title with their number , the text, start time 
and end time in seconds, the text at :
{incoming_query}
User asked this question related to the video chunks, you have to answer where and how much
content is taught where in which video at what timestamp and guide the user to go to that particular video. If user asks 
'''

print("Top 30 most similar chunk indices:", max_indx)
print("-------------------------------------")
print("\nTop 30 most similar chunks:")
print(df_sorted[['title', 'text', 'similarity', 'start', 'end']].head(23))
print("-------------------------------------")
