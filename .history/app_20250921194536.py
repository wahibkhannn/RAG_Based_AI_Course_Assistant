...
# """
    prompt = f"""
        ...
        The course content is divided into video chunks, each with:
        - Title (video number and name)
        - Timestamp (start and end in seconds)
        - Transcript snippet (text of what is being taught)

        Your task:
        1. Answer the user's question **clearly and concisely** using ONLY the provided chunks.
        2. After the answer, provide a structured list of **relevant videos with exact timestamps** that support your answer.
        3. If the question is unrelated to this course, respond exactly: 
        "I can only answer questions about this Java course."
        4. Do NOT add any extra reasoning, explanations, or speculations beyond the chunks.
        5. Ensure the answer is short, direct, and beginner-friendly.
